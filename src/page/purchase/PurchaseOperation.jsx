...
const PurchaseOperation = () => {
  ...
  useEffect(() => {
    ...
    const fetchDataUnit = async () => {
      try {
        const response = await axios.get(
          "http://194.233.87.22:5003/api/unit/getAll"
        );
    ...
    const fetchBrandData = async () => {
      try {
        const response = await axios.get(
          "http://194.233.87.22:5003/api/brand/getAll"
        );
    ...
    const fetchShop = async () => {
      try {
        const response = await axios.get(
          "http://194.233.87.22:5003/api/shopname/getAll"
        );
    ...
    const fetchVatData = async () => {
      try {
        const response = await axios.get(
          "http://194.233.87.22:5003/api/tax/getAll"
        );
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.post(
        "http://194.233.87.22:5003/api/transactionsRouter/postTransactionFromAnyPageBulk",
        saveData,
        {
          headers: {
 ...
 console.log(brandID);
  ...
  }, [tableData, supplierNameID, paid, invoice, product_trace_id, brandID, vatID, NettotalAmount, formattedDate, payment_id]);
  ...
  const saveBrandName = async () => {
    try {
      const response = await axios.post(
        "http://194.233.87.22:5003/api/brand/postBrandFromAnyPage",
        { brand_name }
      );
      if (response.status === 200) {
        setBrand_name("");
  ...
  const handlesaveUnit = async () => {
    try {
      const response = await axios.post(
        "http://194.233.87.22:5003/api/unit/postUnitFromAnyPage",
        { unit }
      );
      if (response.status === 200) {
        setUnit("");
  ...
  const handlesaveVat = async () => {
    try {
      const response = await axios.post(
        "http://194.233.87.22:5003/api/tax/postTaxFromAnyPage",
        { rate }
      );
      if (response.status === 200) {
        setRate("");
  ...
  const handleSaveSupplier = async () => {
    ...
    try {
      const response = await axios.post(
        "http://194.233.87.22:5003/api/contributorname/postContributorNameFromAnyPage",
