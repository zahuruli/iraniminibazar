    ...
    try {
      if (
        ...
        const res = await axios.post(
          "http://194.233.87.22:5003/api/employee/postEmployeeFromAnyPage",
          {
            mobile,
            address,
            nid,
    ...
    try {
      if (!update_employee_id) {
        ...
        const res = await axios.put(
          "http://194.233.87.22:5003/api/employee/updateEmployeeFromAnyPage",
          {
  ...
  const deleteEmployee = async () => {
    try {
      const res = await axios.delete(
        `http://194.233.87.22:5003/api/employee/deleteEmployeeFromAnyPage`,
