...
try {
  const res = await axios.post(`http://194.233.87.22:5003/api/transactionsRouter/postComPaidAmountTransactionFromAnyPage?amount=${total}&paid=${paid}&comment=${expenseName}&date${currentDate}`)
