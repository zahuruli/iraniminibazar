...
const Addproducts = () => {
  ...
  const fetchAllCategory = async () => {
    try {
      const { data } = await axios.get(
        "http://194.233.87.22:5003/api/category/getAll"
      );
      setCategories(data);
    } catch (error) {
      console.log(error);
    ...
    try {
      if (category_name) {
        const res = await axios.post(
          "http://194.233.87.22:5003/api/category/postCategoryFromAnyPage",
          { category_name }
        );
    ...
    try {
      if (category_name && category_id) {
        const res = await axios.put(
          "http://194.233.87.22:5003/api/category/updateCategoryFromAnyPage",
    ...
    try {
      if (category_id) {
        const res = await axios.delete(
          `http://194.233.87.22:5003/api/category/deleteCategoryFromAnyPage`,
          { data: { category_id } }
        );
  ...
  const getAllRack = async () => {
    try {
      const { data } = await axios.get(
        "http://194.233.87.22:5003/api/rack/getAll"
      );
      setRacks(data);
    } catch (error) {
      console.log(error);
  ...
  const saveRack = async () => {
    try {
      if (rack_no) {
        const res = await axios.post(
          "http://194.233.87.22:5003/api/rack/postRackFromAnyPage",
          { rack_no }
        );
  ...
  const handleRackDeleteTrue = async () => {
    try {
      if (rack_id) {
        const res = await axios.delete(
          `http://194.233.87.22:5003/api/rack/deleteRackFromAnyPage`,
          { data: { rack_id } }
        );
        setRackModal(false);
    ...
    try {
      if (!category_id || !rack_id || !product_code || !name) {
        ...
        if (!existingProductName) {
          ...
          const res = await axios.post(
            "http://194.233.87.22:5003/api/producttraces/postProductTraceFromAnyPage",
            {
              category_id,
              rack_id,
              product_code,
  ...
  const updateProduct = async () => {
    try {
      if (!product_trace_id) {
        ...
        const res = await axios.put(
          "http://194.233.87.22:5003/api/producttraces/updateProductTraceFromAnyPage",
          {
            product_trace_id,
            category_id,
            rack_id,
  ...
  const handleProductDeleteTrue = async () => {
    try {
      const res = await axios.delete(
        "http://194.233.87.22:5003/api/producttraces/deleteProductTraceFromAnyPage",
